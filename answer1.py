# 첫번째 스도쿠 정답표
fullBox1 = []
fullBox1.append([8,3,5,4,1,6,9,2,7])
fullBox1.append([2,9,6,8,5,7,4,3,1])
fullBox1.append([4,1,7,2,9,3,6,5,8])
fullBox1.append([5,6,9,1,3,4,7,8,2])
fullBox1.append([1,2,3,6,7,8,5,4,9])
fullBox1.append([7,4,8,5,2,9,1,6,3])
fullBox1.append([6,5,2,7,8,1,3,9,4])
fullBox1.append([9,8,1,3,4,5,2,7,6])
fullBox1.append([3,7,4,9,6,2,8,1,5])
