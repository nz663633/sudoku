fullBox3 = []
fullBox3.append([8,2,7,1,5,4,3,9,6])
fullBox3.append([9,6,5,3,2,7,1,4,8])
fullBox3.append([3,4,1,6,8,9,7,5,2])
fullBox3.append([5,9,3,4,6,8,2,7,1])
fullBox3.append([4,7,2,5,1,3,6,8,9])
fullBox3.append([6,1,8,9,7,2,4,3,5])
fullBox3.append([7,8,6,2,3,5,9,1,4])
fullBox3.append([1,5,4,7,9,6,8,2,3])
fullBox3.append([2,3,9,8,4,1,5,6,7])
